                        ...
                        <div class="table-responsive">
                          <table class="table">
                            <tr>
                              ...
                              <td width="25%">Status Call</td>
                              <td width="25%">Status Data</td>
                            ...
                            function convertToMinuteSecond($start, $end)
                            {
                              ...
                              return $menit . ":" . (($detik < 10) ? "0" . $detik : $detik);
                            }
                            ...
                            if ($result->num_rows > 0) {
                              ...
                              while ($row = $result->fetch_assoc()) {
                                echo '<tr>  
                                        ...
                                        <td width="25%"><span class="badge badge-pill badge-secondary">' . $row["StatusData"] . '</span></td>
                                        <td width="25%">' . $row["CustName"] . '</td>
                                        <td width="25%">' . convertToMinuteSecond($row["StartTime"], $row["EndTime"])  . '</td>
                                      </tr>
                                      <script>console.log("' . $row["StartTime"] . '", "' . $row["EndTime"] . '")</script>
                                      ';
